...
permalink: /programming/javascript/user-guide/index-v3.3.2.html
---
...
- jsDelivr
  ...
  ```html
  <script src="https://cdn.jsdelivr.net/npm/dynamsoft-camera-enhancer@3.3.2/dist/dce.js"></script>
  ```

- UNPKG  

  ```html
  <script src="https://unpkg.com/dynamsoft-camera-enhancer@3.3.2/dist/dce.js"></script>
  ```
