...
permalink: /programming/javascript/api-reference/acquisition-v3.0.1.html
---
...
| [frameColorMode](#framecolormode) | Sets or returns the color mode of the images generated by getFrame(). |
...
Sets or returns the color mode of the images generated by getFrame(). The value is limited to "RGBA" (default), "GREY", "RBGA", "GRBA", "GBRA", "BRGA" and "BGRA".
